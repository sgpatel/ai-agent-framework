                ...
                {synthesis && (
                    <div className="main-answer">
                        ...
                        <div className="answer-metadata">
                            <span className="confidence">Confidence: {Math.round((synthesis.confidence || 0) * 100)}%</span>
                        ...
                        {Object.entries(locationResults).map(([location, data]) => (
                            <div key={location} className="location-result">
                                ...
                                <div className="location-metadata">
                                    ...
                                    {data.population && (
                                        <span className="population">Population: {data.population.toLocaleString()}</span>
                                    )}
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="map-placeholder">
                        <div className="map-info">
                            ...
                            {markers && markers.length > 0 && (
                                <p>Locations: {markers.length} markers</p>
                            )}
                        </div>
