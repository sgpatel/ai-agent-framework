...
const SystemMonitoring = () => {
  ...
  const fetchSystemHealth = async () => {
    try {
      ...
      const [healthResponse, agentsResponse, metricsResponse, llmStatusResponse] =
    ...
    <Card className='mb-4'>
      ...
      <Card.Body>
        ...
        <Row className='mt-4'>
          <Col md={6}>
            <h6>Memory Usage</h6>
            <ProgressBar now={75} variant='info' label='75% (1.2GB / 1.6GB)' className='mb-3' />
          </Col>
          <Col md={6}>
            <h6>CPU Usage</h6>
            <ProgressBar now={45} variant='success' label='45%' className='mb-3' />
          </Col>
        </Row>
      </Card.Body>
    </Card>
              ...
              <tr key={index}>
                ...
                <td>
                  <Badge bg={getStatusBadgeVariant(agent.status || 'healthy')}>
                    {getStatusIcon(agent.status || 'healthy')}{' '}
                ...
                <td>
                  <span className='badge bg-primary'>
                    {agent.tasksCompleted || Math.floor(Math.random() * 50)}
                  </span>
                </td>
                <td>
                  <ProgressBar
      ...
      <Row className='mb-4'>
        <Col>
          <Card className='system-overview'>
            ...
            <Card.Body>
              <Row>{systemHealth.services.map(renderServiceCard)}</Row>
            </Card.Body>
          </Card>
        </Col>
      </Row>
              ...
              <div className='logs-container'>
                <div className='log-entry'>
                  ...
                  <span className='log-message'>
                    Task completed by agent StockAnalyzer in 640ms
                  </span>
                </div>
                <div className='log-entry'>
                ...
                <div className='log-entry'>
                  ...
                  <span className='log-message'>
                    Insufficient data for technical analysis of TCS
                  </span>
                </div>
              </div>
            </Card.Body>
